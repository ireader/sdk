...
inline int spinlock_create(spinlock_t *locker)
{
#if defined(OS_WINDOWS)
...
inline int spinlock_destroy(spinlock_t *locker)
{
#if defined(OS_WINDOWS)
...
inline void spinlock_lock(spinlock_t *locker)
{
#if defined(OS_WINDOWS)
...
inline void spinlock_unlock(spinlock_t *locker)
{
#if defined(OS_WINDOWS)
...
inline int spinlock_trylock(spinlock_t *locker)
{
#if defined(OS_WINDOWS)
