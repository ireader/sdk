...
static void le_read_uint16(const uint8_t* ptr, uint16_t* val)
{
...
static void le_read_uint64(const uint8_t* ptr, uint64_t* val)
{
...
static void le_write_uint16(uint8_t* ptr, uint16_t val)
{
...
static void le_write_uint64(uint8_t* ptr, uint64_t val)
{
...
static void be_read_uint64(const uint8_t* ptr, uint64_t* val)
{
...
static void be_write_uint64(uint8_t* ptr, uint64_t val)
{
