...
inline void le_read_uint16(const uint8_t* ptr, uint16_t* val);
inline void le_read_uint32(const uint8_t* ptr, uint32_t* val);
inline void le_read_uint64(const uint8_t* ptr, uint64_t* val);
inline void le_write_uint16(uint8_t* ptr, uint16_t val);
inline void le_write_uint32(uint8_t* ptr, uint32_t val);
inline void le_write_uint64(uint8_t* ptr, uint64_t val);

// ARM/Motorola big endian(network byte order)
// 0x01020304 -> |01|02|03|04|
inline void be_read_uint16(const uint8_t* ptr, uint16_t* val);
inline void be_read_uint32(const uint8_t* ptr, uint32_t* val);
inline void be_read_uint64(const uint8_t* ptr, uint64_t* val);
inline void be_write_uint16(uint8_t* ptr, uint16_t val);
inline void be_write_uint32(uint8_t* ptr, uint32_t val);
inline void be_write_uint64(uint8_t* ptr, uint64_t val);
